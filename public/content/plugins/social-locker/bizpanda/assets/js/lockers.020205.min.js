...
(function($){
    ...
    window.bizpanda.createLocker = function( $target, data, lockId, mine ) {
        ...
        var getContextData = function() {
            ...
            if ( !context.postId && window.__pandalockers ) context.postId = window.__pandalockers.postId;
    ...
    var bindFunction = function(){
        $(document).ajaxComplete(function() {
            ...
            setTimeout(function(){ window.bizpanda.initLockers(); },3000);     
            setTimeout(function(){ window.bizpanda.initLockers(); },5000);
        });
