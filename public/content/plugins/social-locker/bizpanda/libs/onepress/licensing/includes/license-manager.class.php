...
class OnpLicensing325_LicenseManagerPage extends FactoryPages321_AdminPage  {
    ...
    public function indexAction() {
        ...
        <div class="factory-bootstrap-330 factory-fontawesome-320 onp-page-wrap <?php echo $licenseData['Category'] ?>-license-manager-content" id="license-manager">
                ...
                <div class="license-details">
                    <?php ?>
                        ...
                        <a href="<?php onp_licensing_325_purchase_url( $this->plugin ) ?>" id="purchase-premium">
                            ...
                            <i class="fa fa-star"></i> <?php printf( __('Upgrade to Premium for %1$s', 'onp_licensing_325'), $this->purchasePrice ) ?> <i class="fa fa-star"></i></i>
                            <?php } else { ?>
                            <i class="fa fa-star"></i> <?php _e('Upgrade to Premium', 'onp_licensing_325') ?> <i class="fa fa-star"></i></i>
                            <?php } ?>
                            </span>
                        </a>
                        <?php } ?>
 ...
 ?>   
    ...
    public function finishAction() {
        ...
        ?>
        <div class="factory-bootstrap-330 factory-fontawesome-320 onp-page-wrap onp-single-block" id="finish">
    ...
    public function createAccountAction() {
        ...
        ?>
        <form method="POST">
        <div class="factory-bootstrap-330 factory-fontawesome-320 onp-page-wrap onp-single-block" id="create-account">
    ...
    public function accountAlreadyCreatedAction() {
        ...
        ?>
        <form method="POST">
        <div class="factory-bootstrap-330 factory-fontawesome-320 onp-page-wrap onp-single-block" id="account-already-created">
    ...
    public function accountCreatedAction() {
        ...
        ?>
        <div class="factory-bootstrap-330 factory-fontawesome-320 onp-page-wrap onp-single-block" id="account-created">
    ...
    public function hideLMAction() {
        ...
        <div class="wrap factory-fontawesome-320">
            ...
            <div class="factory-bootstrap-330" >
    ...
    public function activateKeyManualyAction() {
        ...
        ?>
        <div class="factory-bootstrap-330 onp-page-wrap" id="activate-key-manual">
    ...
    public function internalKeysAction( $sender = 'index' ) {
        ...
        <div class="wrap ">
            ...
            <div class="factory-bootstrap-330" style="max-width: 800px;">
