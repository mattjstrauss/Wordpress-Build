...
<html>
    <head>
         ...
         <?php ?>
         <script type="text/javascript" src="<?php echo OPANDA_BIZPANDA_URL ?>/assets/js/lockers.020205.min.js"></script>  
         <link rel="stylesheet" type="text/css" href="<?php echo OPANDA_BIZPANDA_URL ?>/assets/css/lockers.020205.min.css">  
         <?php 
 ?>
