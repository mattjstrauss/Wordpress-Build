            ...
            $form->add(array(  
                array(
                    ...
                    'data'      => array(
                        ...
                        array('blurring', '<i class="fa fa-bullseye"></i>'.__('Blurring', 'bizpanda'), __( 'Works in all browsers except IE 10-11 (In IE 10-11, the transparency mode will be applied)', 'bizpanda' ) )
                    ),
