 ...
 return true; 
    ...
    public function configure() {
        ...
        */  
        ...
        $this->scripts->add( OPANDA_BIZPANDA_URL . '/assets/admin/js/item-edit.010010.js')->request('jquery-ui-sortable');       
        $this->styles->add( OPANDA_BIZPANDA_URL . '/assets/admin/css/item-edit.010010.css');
