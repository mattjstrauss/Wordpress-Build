...
class OPanda_SocialOptionsMetaBox extends FactoryMetaboxes321_FormMetabox
{
    ...
    public $cssClass = 'factory-bootstrap-330 factory-fontawesome-320';
        ...
        $tabs['items'][] = array(
            ...
            'items'     => array(
                ...
                array(
                    'type'  => 'checkbox',
                    'way'   => 'buttons',
                    'title' => __('Double Check', 'sociallocker'),
                    'hint'  => __('Optional. Checks whether the user actually has tweeted or not. Requires the user to authorize the BizPanda app.', 'sociallocker'),
            ...
            'items'     => array(
                array(
                    ...
                    'html'  => '<div class="alert alert-warning">'.
                                sprintf( __('<strong>Warning:</strong> The Google +1 button started working as the Google Share button <a target="_blank" href="https://plus.google.com/110610523830483756510/posts/Z1FfzduveUo">since 15 June 2017</a>.<br />Please make sure that you <a href="%s">set a Google Client ID</a> for your domain, otherwise the button will not work correctly.', 'sociallocker'), opanda_get_settings_url('social') )
                                .'</div>'
                ),
                array(
                    'off'   =>  empty($googleClientId),
                    'type'  => 'html',
                    'html'  => '<div class="alert alert-warning">'.
                                sprintf( __('<strong>Note:</strong> The Google +1 button started working as the Google Share button <a target="_blank" href="https://plus.google.com/110610523830483756510/posts/Z1FfzduveUo">since 15 June 2017</a>.', 'sociallocker'), opanda_get_settings_url('social') )
                                .'</div>'
                ),
                array(
                    'type'      => 'checkbox',
                ...
                array(
                    'type'  => 'textarea',
                    'title' => __('Prefilled Comment', 'sociallocker'),
                    'hint'  => __('Type a message which will be prefilled in the comment box. Also you can use the shortcode [post_title] in order to insert automatically a post title into the comment.', 'sociallocker'),
