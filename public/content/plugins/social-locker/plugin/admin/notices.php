<?php
    ...
    function onp_sl_upgrade_to_premium_notices( $notices ) {
        ...
        $wasClosed = isset( $closed['onp-sl-offer-to-purchase'] );
        
        $lastCloase  = isset( $closed['onp-sl-offer-to-purchase'] ) 
            ? $closed['onp-sl-offer-to-purchase']['time'] 
            : 0;
        
        $neverShow = isset( $closed['onp-sl-offer-to-purchase'] ) 
            ? intval( $closed['onp-sl-offer-to-purchase']['never'] )
            : false;
