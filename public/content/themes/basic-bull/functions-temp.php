...
function basic_bull_setup() {
	 ...
	 * If you're building a theme based on basic-bull, use a find and replace
	 * to change 'bullinteractive-co' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'bullinteractive-co', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'bullinteractive-co' ),
	) );
...
function basic_bull_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'bullinteractive-co' ),
...
function basic_bull_scripts() {
	...
	wp_enqueue_script( 'bullinteractive-co-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
