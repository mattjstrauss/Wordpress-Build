<?php
	...
	$backgroundVideoSource = get_sub_field('background_video_source');
	$backgroundVideoEmbed = get_sub_field('background_video_embed');
	$backgroundVideoFile = get_sub_field('background_video_file');
	$backgroundImage = get_sub_field('background_image');
	$backgroundColor = get_sub_field('background_color');
	$backgroundOverlay = get_sub_field('background_overlay');
	$backgroundPositionVertical = get_sub_field('background_position_vertical');
	$backgroundPositionHorizontal = get_sub_field('background_position_horizontal');
